    ...
    */
    ...
    const menuItems = [
        ...
        },
        {
            ...
            subMenuItems: [
                {
                    show: true, title: (siteInfo?.paidModules && siteInfo?.paidModules?.includes('OrderBook')) ? 'معاملات آنی' : 'معاملات', href: '/admin/panel/trades'
                },
                {
                    show: (siteInfo?.paidModules && siteInfo?.paidModules?.includes('OrderBook')) ? true : false, title: 'معاملات پیشرفته', href: '/admin/panel/orderbooks'
                },
                {

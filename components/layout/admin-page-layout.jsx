...
const AdminPageLayout = ({ children }) => {
    ...
    */
    ...
    const canSeeSidebar = (permission) => isSuperAdmin || sidebarPermissions.includes(permission);

    const menuItems = [
        { show: true, title: 'داشبورد', href: '/admin/panel', icon: <GridViewOutlinedIcon className="text-black dark:text-white" /> },
        {
            show: canSeeSidebar('users') || canSeeSidebar('admins'), title: 'کاربران', hasSubMenu: true, icon: <svg width="24" height="24" viewBox="0 0 24 24" className="svg-icon text-black dark:text-white">
            ...
            subMenuItems: [
                {
                    show: canSeeSidebar('users'), title: 'کاربران', href: '/admin/panel/users'
                },
                {
                    show: canSeeSidebar('admins'), title: 'ادمین ها', href: '/admin/panel/admins'
                }
            ]
        },
        {
            show: canSeeSidebar('products'), title: 'محصولات', hasSubMenu: true, icon: <svg viewBox="0 0 24 24" className="svg-icon text-black dark:text-white"><path d="M6.33 2.285a1 1 0 0 0-.41.088s-.375.165-.77.451c-.394.286-1.006.721-1.006 1.65v15.05c0 1.194.99 2.19 2.186 2.19h11.34a2.204 2.204 0 0 0 2.184-2.19V8.104a1 1 0 0 0-.289-.705l-4.803-4.818a1 1 0 0 0-.709-.295zm.26 2h6.359v2.799c0 1.161.959 2.125 2.12 2.125h2.788v10.32c0 .124-.068.19-.186.19H6.331c-.118 0-.185-.066-.185-.19V4.609c.004.063.03-.054.18-.162.127-.093.185-.115.265-.156zm8.109 1.064 2.105 2.111H15.07c-.22 0-.371-.152-.371-.377zM8.568 9.79a.875.875 0 0 0-.875.875.875.875 0 0 0 .875.875H12.3a.875.875 0 0 0 .875-.875.875.875 0 0 0-.875-.875zm0 2.939a.875.875 0 0 0-.875.875.875.875 0 0 0 .875.875h5.357a.875.875 0 0 0 .875-.875.875.875 0 0 0-.875-.875zm0 2.938a.875.875 0 0 0-.875.877.875.875 0 0 0 .875.875h6.863a.875.875 0 0 0 .875-.875.875.875 0 0 0-.875-.877z"></path></svg>,
            subMenuItems: [
                {
                    show: canSeeSidebar('products'), title: 'واحدهای قابل معامله', href: '/admin/panel/tradeables'
                },
                {
                    show: canSeeSidebar('products'), title: 'محصولات', href: '/admin/panel/products'
                },
                {
                    show: canSeeSidebar('products'), title: 'تحویل فیزیکی محصولات', href: '/admin/panel/productstransactions'
                },
                {
                    show: canSeeSidebar('products'), title: 'شعب تحویل فیزیکی', href: '/admin/panel/productsbranch'
                },
                {
                    show: canSeeSidebar('products'), title: 'سپرده گذاری', href: '/admin/panel/stakings'
                },
                {
                    show: canSeeSidebar('products'), title: 'تعیین کارمزد معاملاتی برای کاربران', href: '/admin/panel/user-fees'
                }
            ]
        },
        {
            show: canSeeSidebar('giftCards'), title: 'گیفت کارت ها', hasSubMenu: true, icon: <svg width="24" height="24" viewBox="0 0 24 24" className="svg-icon text-black dark:text-white">
            ...
            subMenuItems: [
                {
                    show: canSeeSidebar('giftCards'), title: 'درخواست های گیفت کارت', href: '/admin/panel/giftcards'
                },
                {
                    show: canSeeSidebar('giftCards'), title: 'تنظیمات', href: '/admin/panel/giftcardsettings'
                },
            ]
        },
        {
            show: canSeeSidebar('limitations'), title: 'اعمال محدودیت', hasSubMenu: true, icon: <svg width="24" height="24" viewBox="0 0 24 24" className="svg-icon text-black dark:text-white">
            ...
            subMenuItems: [
                {
                    show: canSeeSidebar('limitations'), title: 'محدودیت برداشت', href: '/admin/panel/withdrawlimits'
                },
                {
                    show: canSeeSidebar('limitations'), title: 'ساعات محدودیت معاملات', href: '/admin/panel/tradelimits'
                },
            ]
        },
        {
            show: canSeeSidebar('accounting'), title: 'حسابداری', hasSubMenu: true, icon: <svg width="24" height="24" viewBox="0 0 24 24" className="svg-icon text-black dark:text-white">
            ...
            subMenuItems: [
                {
                    show: canSeeSidebar('accounting'), title: 'معاملات آنی', href: '/admin/panel/trades'
                },
                {
                    show: canSeeSidebar('accounting'), title: 'معاملات پیشرفته', href: '/admin/panel/orderbooks'
                },
                {
                    show: canSeeSidebar('accounting'), title: 'تراکنش های تومان', href: '/admin/panel/fiattransactions'
                },
                {
                    show: canSeeSidebar('accounting'), title: 'انتقال های دارایی', href: '/admin/panel/transfers'
                },
                {
                    show: canSeeSidebar('accounting'), title: 'حسابداری', href: '/admin/panel/financial'
                },
                {
                    show: canSeeSidebar('accounting'), title: 'کیف پولها', href: '/admin/panel/wallets'
                },
                {
                    show: canSeeSidebar('accounting'), title: 'کارت های بانکی', href: '/admin/panel/bankaccounts'
                },
                {
                    show: canSeeSidebar('accounting'), title: 'تاریخچه خروجی معاملات', href: '/admin/panel/exports'
                }
            ]
        },
        {
            show: canSeeSidebar('messages'), title: 'پیام ها', name: 'ticket', hasSubMenu: true, icon: <svg width="24" height="24" viewBox="0 0 24 24" className="svg-icon text-black dark:text-white">
            ...
            subMenuItems: [
                {
                    show: canSeeSidebar('messages'), title: 'پیام ها', href: '/admin/panel/messages'
                },
                {
                    show: canSeeSidebar('messages'), title: 'تیکت ها', href: '/admin/panel/tickets', name: 'ticket'
                }
            ]
        },
        {
            show: canSeeSidebar('sms'), title: 'پیامک', hasSubMenu: true, href: '', icon: <svg width="24" height="24" viewBox="0 0 24 24" className="svg-icon text-black dark:text-white">
